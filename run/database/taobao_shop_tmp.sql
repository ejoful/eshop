...
--
-- Host: localhost
-- Generation Time: 2018-06-09 16:31:12
...
--
-- 表的结构 `tbl_category_tmp`
--

CREATE TABLE IF NOT EXISTS `tbl_category_tmp` (
...
--
-- 转存表中的数据 `tbl_category_tmp`
--

INSERT INTO `tbl_category_tmp` (`catid`, `name`, `parentid`) VALUES
(1, '文化玩乐', NULL),
(2, '乐器/吉他/钢琴/配件', 1),
(3, '西洋乐器', 2),
(4, '西洋键盘乐器', 3),
...
--
-- 表的结构 `tbl_item_attribute_tmp`
--

CREATE TABLE IF NOT EXISTS `tbl_item_attribute_tmp` (
...
--
-- 转存表中的数据 `tbl_item_attribute_tmp`
--

INSERT INTO `tbl_item_attribute_tmp` (`id`, `itemid`, `attrid`, `value`) VALUES
(1, 1, 1, '音格格'),
(2, 1, 7, 'Q8'),
(3, 1, 3, '88键'),
(4, 1, 4, '101种(含)-200种(含)'),
...
CREATE TABLE IF NOT EXISTS `tbl_item_cat` (
  `cid` int(10) unsigned NOT NULL COMMENT '商品所属类目ID',
  `features` varchar(30) DEFAULT NULL COMMENT 'Feature对象列表 目前已有的属性： 若Attr_key为 udsaleprop，attr_value为1 则允许卖家在改类目新增自定义销售属性,不然为不允许',
  `is_parent` tinyint(1) NOT NULL COMMENT '该类目是否为父类目(即：该类目是否还有子类目)',
  `spell` varchar(100) NOT NULL COMMENT '汉语拼音首字母拼写',
  `name` varchar(100) NOT NULL COMMENT '类目名称',
  `spuid` int(10) NOT NULL DEFAULT '0',
  `leaf` tinyint(4) NOT NULL COMMENT '是否叶子节点，0：非叶子节点，1：叶子节点，2：还有子目录，20000:3376399，手卷钢琴，品牌，EVA',
  `parent_cid` int(10) NOT NULL COMMENT '父类目ID=0时，代表的是一级的类目',
  `sort_order` tinyint(4) NOT NULL COMMENT '排列序号，表示同级类目的展现次序，如数值相等则按名称次序排列。取值范围:大于零的整数',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态。可选值:0(正常),1(删除)',
  `taosir_cat` tinyint(1) NOT NULL COMMENT '是否度量衡类目',
  `created` datetime DEFAULT NULL COMMENT '类目在原系统创建时间',
  `modified` datetime DEFAULT NULL COMMENT '类目在原系统修改时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品类目结构';
...
CREATE TABLE IF NOT EXISTS `tbl_item_prop` (
  `child_template` varchar(500) DEFAULT NULL COMMENT '属性的模板（卖家自行输入属性时需要用到）',
  `cid` int(10) NOT NULL COMMENT '类目ID',
  `features` varchar(100) DEFAULT NULL COMMENT '属性的feature列表',
  `is_allow_alias` tinyint(1) NOT NULL COMMENT '是否允许别名。可选值：true（是），false（否）'
...
--
-- Indexes for table `tbl_category_tmp`
--
ALTER TABLE `tbl_category_tmp`
...
--
-- Indexes for table `tbl_item_attribute_tmp`
--
ALTER TABLE `tbl_item_attribute_tmp`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_item_cat`
--
ALTER TABLE `tbl_item_cat`
  ADD PRIMARY KEY (`cid`);
...
--
-- AUTO_INCREMENT for table `tbl_category_tmp`
--
ALTER TABLE `tbl_category_tmp`
...
--
-- AUTO_INCREMENT for table `tbl_item_attribute_tmp`
--
ALTER TABLE `tbl_item_attribute_tmp`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `tbl_item_cat`
--
ALTER TABLE `tbl_item_cat`
  MODIFY `cid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '商品所属类目ID';
--
